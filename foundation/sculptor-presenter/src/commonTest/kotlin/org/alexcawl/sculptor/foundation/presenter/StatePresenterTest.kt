...
abstract class StatePresenterTest<SC : StateContract> : PresenterTest<Section, Layout>() {
    final override val presenters: List<Presenter<*, *>>
        get() = super.presenters + presenter + statePresenter

    final override val presenter: SectionPresenter
        get() = SectionPresenter
    ...
    abstract override val input: Section
