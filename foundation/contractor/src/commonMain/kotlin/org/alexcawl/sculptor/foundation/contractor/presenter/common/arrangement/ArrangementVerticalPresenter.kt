...
internal class ArrangementVerticalPresenter : Presenter<SculptorArrangement.Vertical, ComposeArrangement.Vertical>() {
    ...
    override suspend fun PresenterScope.dslTransform(input: SculptorArrangement.Vertical): ComposeArrangement.Vertical {
        return when (input) {
